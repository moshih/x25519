...
//this copies one 256 bit array to another
...
fn crypto_scalarmult_curve25519(r:&mut [u8;32],s:& [u8;32],p:& [u8;32]){
...
fn crypto_scalarmult_curve25519_base(q:&mut [u8;32],n:& [u8;32]){
...
fn fe25519_print(arr:&[u32;8]){
  
  println!("We have {} {} {} {} {} {} {} {}",arr[0],arr[1],arr[2],arr[3],arr[4],arr[5],arr[6],arr[7]);

}

fn fe25519_printu8(r:&[u8;32]){
  
  println!("We have {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}",r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15],r[16],r[17],r[18],r[19],r[20],r[21],r[22],r[23],r[24],r[25],r[26],r[27],r[28],r[29],r[30],r[31]);
...
let mut end=0;
  ...
  crypto_scalarmult_curve25519_base(&mut result1,& alice2);
  crypto_scalarmult_curve25519_base(&mut result2,& bob2);

unsafe {

ast::AST.set_alarm(160000);
begin=ast::AST.now();}


  crypto_scalarmult_curve25519(&mut result, & bob2, & result1);

unsafe {end=ast::AST.now();}
end=end-begin;
println!("total time is {}",end);
fe25519_printu8(& result);

  crypto_scalarmult_curve25519(&mut result, & alice2, & result2);
fe25519_printu8(& result);

  crypto_scalarmult_curve25519(&mut result, & alice, & bob);
fe25519_printu8(& result);
