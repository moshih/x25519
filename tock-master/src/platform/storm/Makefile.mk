...
all: $(BUILD_PLATFORM_DIR)/libplatform.rlib $(BUILD_PLATFORM_DIR)/ctx_switch.o $(BUILD_PLATFORM_DIR)/mul.o $(BUILD_PLATFORM_DIR)/sqr.o $(BUILD_PLATFORM_DIR)/mpy.o $(BUILD_PLATFORM_DIR)/red.o $(BUILD_PLATFORM_DIR)/kernel.o
